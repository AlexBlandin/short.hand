/*
  cwd_polyglot.h - Cross-platform Current Working Directory Library
  ...
  AS A SINGLE FILE HEADER LIBRARY:
     ...
     For a standalone program and a demonstration of usage, see the other
     version, "cwd_polyglot.c", instead, as that can compile via a main()
     function that it tries to switch "magically"... compiler permitting.
